...
namespace ARChess.Scripts.AR
{
    /// <summary>
    /// A custom implementation of a <see cref="ConfigurationChooser"/>.
    /// </summary>
    public class PreferCameraConfigurationChooser : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_Session.subsystem.configurationChooser = new ARFConfigurationChooser();
        }

        class ARFConfigurationChooser : ConfigurationChooser
        {
            /// <summary>
